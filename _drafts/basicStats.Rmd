...
Try some other examples to get the hang of it typing `example(boxplot)`

You can also find a good small tutorial on boxplots in R here:  
...
$$\large{\sigma = \frac{{\sum{(x - \overline{x}})^2}{n}}$$ 
